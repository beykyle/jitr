...
class InteractionMatrix:
    ...
    def __init__(self, nchannels: np.int32 = 1, local_arg_type=tuple, nonlocal_arg_type=tuple):
        ...
        self.local_args = np.empty((self.nchannels, self.nchannels), dtype=local_arg_type)
        self.nonlocal_args = np.empty((self.nchannels, self.nchannels), dtype=nonlocal_arg_type)
